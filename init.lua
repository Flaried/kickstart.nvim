...
require('lazy').setup({
  ...
  {                     -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>g', group = 'Tabs' },
        { '<leader>f', group = '[F]unctions/Workplace' },
  ...
  },
  {
    ...
    opts = {
      setup = {
        rust_analyzer = function() end, -- Disable setup for rust_analyzer
      },
    },
    dependencies = {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Find references for the word under your cursor in a vertical split.
          map('gr', function()
            vim.cmd 'vsplit'
            require('telescope.builtin').lsp_references()
          end, '[G]oto [R]eferences')

          -- Jump to the implementation of the word under your cursor in a vertical split.
          map('gI', function()
            vim.cmd 'vsplit'
            require('telescope.builtin').lsp_implementations()
          end, '[G]oto [I]mplementation')

          -- Jump to the type of the word under your cursor in a vertical split.
          map('<leader>D', function()
            vim.cmd 'vsplit'
            require('telescope.builtin').lsp_type_definitions()
          end, 'Type [D]efinition')

          -- Fuzzy find all the symbols in your current document in a vertical split.
          map('<leader>fc', function()
            vim.cmd 'vsplit'
            require('telescope.builtin').lsp_document_symbols()
          end, '[F]unction [C]urrent [S]ymbols')

          -- Fuzzy find all the symbols in your current workspace in a vertical split.
          map('<leader>fs', function()
            vim.cmd 'vsplit'
            require('telescope.builtin').lsp_dynamic_workspace_symbols()
          end, '[F]unction [S]ymbols')
          ...
          -- You can add this inside your `config` function or inside your custom key mappings
